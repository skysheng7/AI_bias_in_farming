...
> This folder is hidden from GitHub because images are too big. Please download the images in the databse following the link to [Dataset DOI](https://doi.org/10.6084/m9.figshare.28087691) in the README file in the root directory.
...
Contains images (quality reduced to 50% compared to original images stored in `dall-e-3-images` and `sd3.5-large-images`) organized by the cluster label, to quickly judge the legitimacy of the clutering visually. The cluster was automatically generated by GPT4o

#### 3.1 cluster/dall-e-3/

Clustering images generated by DALL-E 3 into 3 categories: "indoor", "outdoor", "other":
...
#### 3.2 cluster/sd3.5-large/

Clustering images generated by Stable Diffusion 3.5-large into 3 categories: "indoor", "outdoor", "other":
...
### 4. cluster_post_manual_fix/

> This folder is hidden from GitHub because images are too big. Please download the images in the databse following the link to [Dataset DOI](https://doi.org/10.6084/m9.figshare.28087691) in the README file in the root directory.

Contains the same folder structure as the `cluster` directory, but with corrected cluster labels after manual verification and fixes based on the images automatically clustered by GPT4o:
