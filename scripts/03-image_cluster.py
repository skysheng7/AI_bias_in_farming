...
@click.option(
    ...
    default=0,
    type=int,
    help="The starting index in the dataframe which stores all the metadata of generated images. This will be the index of the first image that get processed: clustering using GPT4o. Default is 0.",
)
@click.option(
    "--end_index",
    default=None,
    type=int,
    help="The end index in the dataframe which stores all the metadata of generated images. This wil be the index of the last image that get processed: clustering using GPT4o. Default is None, so end of the dataframe.",
)
