...
def main():
    ...
    print("Start pasting images into 3 categories, with the goal of visualizing how well the auto-clustering performs. See images in results/cluster")
    ...
    print("Start pasting images into 3 categories, with the goal of visualizing image clusters post manual-corrections. See images in results/cluster_post_manual_fix")
    dest_base = Path() / "results" / "cluster_post_manual_fix"
    module5_extract_pic_feature_words.cluster_farm_images(
        megadata2, source_base, dest_base
    )
    print("Finished pasting images into 3 categories, based on auto-clustering post manual corrections.")
    ...
    print("Generated a plot grid summarizing prompting results using Stable Diffussion 3.5-large.")
