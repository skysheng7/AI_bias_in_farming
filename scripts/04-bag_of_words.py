...
def main():
    ...
    print("Finished 1-gram bag of words analysis for revised prompts.")
    ...
    print("Finished 2-gram bag of words analysis for revised prompts.")
    (
    ...
    print("Finished 1-gram and 2-gram bag of words analysis for revised prompts.")
    ...
    print(
        "Finished 1-gram bag of words analysis for text descriptions of images generated by GPT-4o."
    )
    ...
    print(
        "Finished 2-gram bag of words analysis for text descriptions of images generated by GPT-4o."
    )
    (
    ...
    print(
        "Finished 1-gram and 2-gram bag of words analysis for text descriptions of images generated by GPT-4o."
    )
